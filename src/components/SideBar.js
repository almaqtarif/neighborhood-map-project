...
export default class SideBar extends Component {
	...
	handleChange = e => {
		...
		const isMatched = venue.name.toLowerCase().includes(e.target.valuetoLowerCase())
	...
	render() {
		return (
				<div className='sideBar'>
					<input type={"search"} id={"search"} className="side-search" placeholder={"Filter Venues"} onChange={this.handleChange} />
